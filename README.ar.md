...
# 🦁 XXD Panel 084｜دفتر التنقيط والخط

### يختزل الصورة إلى رسم حضري هادئ بخطوط هندسية ونقاط جوية
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 084 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يملأ الرسم الكامل المدن والمشاهد بتفاصيل عارضة، بينما تزيل المحيطات السوداء الغليظة والمرشحات الحاسوبية الهواء والضوء والعمق وانضباط النشر المستقل.

يصفّي **Panel 084** العنصر والعمارة والطرق والعلاقات المكانية بهندسة داكنة رفيعة، ثم يبني الجو عبر density-based stippling في السماء والأرض والبعيد والظل والضوء. تُحذف الخلفيات المعقدة ولا يبقى إلا تركيز واضح وفراغ واسع وقليل من ألوان الأصل المميزة.

### مناسب لـ

- توضيح المدن والعمارة والطرق والعلاقات المكانية بخطوط هندسية رفيعة وأدلة منظور؛
- التعبير عن الهواء والضوء والعمق بكثافة التنقيط لا بالملمس المملوء؛
- استخدام أزرق رمادي وعاجي وأبيض دافئ مع عدد قليل فقط من spot colors المشتقة من الأصل؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 084 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** رسم حضري بسيط · هيكل هندسي · تنقيط قائم على الكثافة · خطوط منظور قائدة · ألوان محدودة · فراغ شعري
...
|---|---|
| **الناتج** | ملصق خطي حديث يشبه مقالة مدينية أو رسماً معمارياً أو مخطط بنية مشهد |
| **البصمة الواضحة** | خطوط هندسية رفيعة وleading lines واضحة وتدرج تنقيط وأزرق رمادي وأبيض دافئ وspot color قليل |
| **احترام المصدر** | يحفظ العنصر والمحيط والبنية والوضع والتوجيه المكاني، ولا يأخذ اللون إلا من أميز درجات الأصل |
...
```text
استخلاص العنصر والبنية والوضع والتوجيه المكاني → اختزال المشهد إلى هيكل هندسي رفيع → بناء المنظور وleading lines → استخدام كثافة التنقيط للهواء والضوء والعمق والظل → تنظيم أرضية زرقاء رمادية وبيضاء دافئة → إضافة spot colors قليلة من الأصل → وضع ملاحظات تحريرية هادئة في الفراغ
```

## سمات النتيجة النهائية

- تبني الخطوط الرأسية والأفقية والمكسرة والمنحنية والمنظورية الهيكل المكاني.
- تصنع كثافة النقاط الهواء والضوء وعمق المجال والطبقات بدلاً من التظليل الثقيل.
- تكوّن الطرق والعمارة والأسلاك والأشجار والحدود leading lines نحو بؤرة واحدة.
- تُختزل الخلفية المعقدة إلى إشارات بنيوية قليلة وفراغ تنفس واسع.
- يهيمن الأزرق الرمادي والأبيض الدافئ، ولا يظهر الأصفر أو لون الأصل إلا كتأكيد منضبط.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-084-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 084. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-084 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-084 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-084 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-084 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-084 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 084 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-084 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-084`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-084-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-084-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ84 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 084 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–084) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
