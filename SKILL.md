...
```text
/xxd-panel-084 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，084 设计在下）
2. 左右对照（原图在左，084 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-084/<fresh-task>/
...
- `references/xxd-panel-084-prompt.zh-CN.md`
- `references/xxd-panel-084-prompt.en.md`
